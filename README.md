...
* `START_MESSAGE` Opsional: Pesan /start memulai awalan ke bot, Gunakan <a href='https://github.com/emysyak/File-Sharing-Man/blob/main/README.md#start_message'>format</a> parsemode HTML 
